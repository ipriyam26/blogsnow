...
props:{
    ...
    const {textbg} = props
    return (<form className="my-5 sm:flex">
        ...
        <div>
            ...
            <p className={` text-sm my-1.5 ${textbg? 'text-gray-800':'text-gray-200'} font-light`}>We care about your data in our <u>
                privacy policy.
            </u>
            </p>
        </div>
...
function Subscribe() {
    return (
        <div className={`bg-gray-800 ${inter.className} py-24 flex flex-col items-center`}>
            <h5 className=" text-3xl text-center text-white">Sign up for our newsletter</h5>
            ...
            <EmailBox textbg={false} ></EmailBox>
        </div>
    )
}
